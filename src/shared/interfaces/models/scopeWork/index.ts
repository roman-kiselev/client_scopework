export type { ICreateScopeWork } from './ICreateScopeWork';
export type { IDataShortScopeWork } from './IDataShortScopeWork';
export type { IEditScopeWork } from './IEditScopeWork';
export type { IListByScopeWorkId } from './IListByScopeWorkId';
